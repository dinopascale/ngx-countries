...
@Component({
  ...
  template: `
    <div class="toolbar no-desktop">
      <ng-container *ngFor="let action of actions" (click)="actionClicked.emit(action.eventSign)">
        <div class="__action" [ngClass]="action.label.toLowerCase() === 'home' ? 'primary-fg' : 'grey-dark-fg'">
